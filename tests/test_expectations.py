...
def test_sampling():
    ...
    target_st = jnp.sqrt(target_pmf).reshape((2,) * int(jnp.rint(jnp.log2(target_pmf.size))))
    ...
    assert sample_bitstrings.shape == (n_samps, int(jnp.rint(jnp.log2(target_pmf.size))))
